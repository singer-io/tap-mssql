"""
Test table reset feature for logical replication
"""
...
class LogicalTableReset(BaseTapTest):
    """ Test table reset feature for logical replication """

    EXPECTED_METADATA = dict()

    def name(self):
        return "{}_log_table_reset_test".format(super().name())
    ...
    def test_run(self):
        ...
        # verify record counts of stream (1 record syncd twice for full table and log based)
        ...
        # ------------------------------------------------------------------------------------------
        # invoke the sync job AGAIN without state manipulation and verify only one record replicated
        # ------------------------------------------------------------------------------------------

        # update expectations to only get the last record
